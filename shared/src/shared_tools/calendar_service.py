...
class CalendarService(QObject):
    ...
    def update_event(self, event_id: int, **fields) -> bool:
        ...
        from shared_tools.ipc_bridge import update_calendar_event_db
        ...
        if also_delete_outlook:
            for e in self._events:
                if e.get("id") == event_id:
                    ...
                    break
            if outlook_id:
                from shared_tools.outlook_tool import delete_calendar_event
    ...
    def update_outlook_event(self, event_id: int, **fields) -> bool:
        ...
        if not event or not event.get("outlook_event_id"):
            return False
        from shared_tools.outlook_tool import update_calendar_event
    ...
    def poll_amail_status(self) -> bool:
        ...
        from shared_tools.ipc_bridge import get_app_status
    ...
    def consume_emails(email_ids: list[str]):
        from shared_tools.ipc_bridge import mark_email_consumed
